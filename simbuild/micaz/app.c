...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x40342438, const void *arg_0x403425d0);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 251
extern double erfc(double arg_0x4038d320) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x404d1320), 
int (*key_eq_fn)(void *arg_0x404d1768, void *arg_0x404d18e0));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x40608010, int arg_0x40608168);
static double RandomUniform(void );
...
static void SensorNetworkForAnimalHusbandryC$Leds$set(uint8_t val);
# 16 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
...
static error_t /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
#line 126
# 134 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void SensorNetworkForAnimalHusbandryC$Leds$set(uint8_t val){
#line 134
  LedsP$Leds$set(val);
#line 134
}
#line 134
# 60 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline message_t *SensorNetworkForAnimalHusbandryC$Receive$receive(message_t *msg, void *payload, uint8_t len)
#line 60
{
...
#line 64
      SensorNetworkForAnimalHusbandryC$Leds$set(__nesc_ntoh_uint16(btrpkt->counter.nxdata));
      sim_log_debug(162U, "BlinkToRadioC", "Received packet of length %hhu and from %hhu.\n", len, __nesc_ntoh_uint16(btrpkt->nodeid.nxdata));
    }

  if (!SensorNetworkForAnimalHusbandryC$busy[sim_node()]) {
      BlinkToRadioMsg *btrpkt = (BlinkToRadioMsg *)SensorNetworkForAnimalHusbandryC$Packet$getPayload(&SensorNetworkForAnimalHusbandryC$pkt[sim_node()], sizeof(BlinkToRadioMsg ));

#line 70
      __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID);
      sim_log_debug(163U, "BlinkToRadioC", "TOS_NODE_ID: %hhu.\n", TOS_NODE_ID);
      __nesc_hton_uint16(btrpkt->counter.nxdata, SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
      if (SensorNetworkForAnimalHusbandryC$AMSend$send(TOS_NODE_ID + 1, &SensorNetworkForAnimalHusbandryC$pkt[sim_node()], sizeof(BlinkToRadioMsg )) == SUCCESS) {
          sim_log_debug(164U, "BlinkToRadioC", "BlinkToRadioC: packet sent.\n", SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x40860ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x40860ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x40860ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
{
  LedsP$Led1$clr();
  sim_log_debug(152U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 91
  ;
}
...
{
  LedsP$Led1$set();
  sim_log_debug(153U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 96
  ;
}
...
{
  LedsP$Led2$clr();
  sim_log_debug(155U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 106
  ;
}
...
{
  LedsP$Led2$set();
  sim_log_debug(156U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 111
  ;
}
...
#line 162
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40b47a70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40b47a70, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x40860108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x40860108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x4085e178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x4085e178, msg, payload, len);
#line 78
...
#line 64
# 25 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$AMControl$startDone(error_t err)
#line 25
{
  if (err == SUCCESS) {
...
# 34 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$AMControl$stopDone(error_t err)
#line 34
{
}
...
# 37 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$AMSend$sendDone(message_t *msg, error_t error)
#line 37
{
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40b47088, message_t * msg, error_t error){
#line 100
  switch (arg_0x40b47088) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40b47088, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x4038cce0){
#line 75
  switch (arg_0x4038cce0) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x4038cce0);
#line 75
      break;
#line 75
    }
...
#line 53
# 43 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$Timer0$fired(void )
#line 43
{
  SensorNetworkForAnimalHusbandryC$counter[sim_node()]++;
  sim_log_debug(159U, "BlinkToRadioC", "BlinkToRadioC: timer fired, counter is %hu.\n", SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
  SensorNetworkForAnimalHusbandryC$Leds$set(SensorNetworkForAnimalHusbandryC$counter[sim_node()]);

  if (!SensorNetworkForAnimalHusbandryC$busy[sim_node()] && TOS_NODE_ID == 1) {
      BlinkToRadioMsg *btrpkt = (BlinkToRadioMsg *)SensorNetworkForAnimalHusbandryC$Packet$getPayload(&SensorNetworkForAnimalHusbandryC$pkt[sim_node()], sizeof(BlinkToRadioMsg ));

#line 50
      __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID);
      sim_log_debug(160U, "BlinkToRadioC", "TOS_NODE_ID: %hhu.\n", TOS_NODE_ID);
      __nesc_hton_uint16(btrpkt->counter.nxdata, SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
      if (SensorNetworkForAnimalHusbandryC$AMSend$send(TOS_NODE_ID + 1, &SensorNetworkForAnimalHusbandryC$pkt[sim_node()], sizeof(BlinkToRadioMsg )) == SUCCESS) {
          sim_log_debug(161U, "BlinkToRadioC", "BlinkToRadioC: packet sent.\n", SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
          SensorNetworkForAnimalHusbandryC$busy[sim_node()] = TRUE;
        }
    }
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b03c70){
#line 83
  switch (arg_0x40b03c70) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b03c70);
#line 83
      break;
#line 83
    }
...
#line 62
# 20 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$Boot$booted(void )
#line 20
{
  sim_log_debug(158U, "BlinkToRadioC", "BlinkToRadioC: timer fired, counter is %hu.\n", SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
  SensorNetworkForAnimalHusbandryC$AMControl$start();
}
