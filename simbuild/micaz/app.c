...
# 59 "/opt/tinyos-2.1.2/tos/lib/tossim/sim_mote.h"
...
typedef nx_struct MoteInformation {
  ...
  nx_uint16_t migrated;
} __attribute__((packed)) MoteInformation;
...
} __attribute__((packed)) AdjacentMote;




#line 40
typedef nx_struct FeedingSpot {
  nx_uint8_t feedingSpotID;
  nx_uint16_t foodAmount;
} __attribute__((packed)) FeedingSpot;



#line 45
typedef nx_struct UpdateFoodAmountOfAnimal {
  nx_uint16_t newAmount;
} __attribute__((packed)) UpdateFoodAmountOfAnimal;




#line 49
typedef nx_struct UpdateFoodAmountOfFeedingSpot {
  nx_uint16_t feedingSpotID;
  nx_uint16_t newAmount;
} __attribute__((packed)) UpdateFoodAmountOfFeedingSpot;


#line 54
typedef nx_struct request_msg {
} __attribute__((packed)) request_msg;
...
# 53 "/opt/tinyos-2.1.2/tos/lib/tossim/SimSchedulerBasicP.nc"
enum SimSchedulerBasicP$__nesc_unnamed4285 {
