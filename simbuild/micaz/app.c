...
# 150 "/usr/lib/gcc/i486-linux-gnu/4.7/include/stddef.h" 3
...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x40349438, const void *arg_0x403495d0);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 251
extern double erfc(double arg_0x4038c320) __attribute((__nothrow__)) ;
...
# 40 "/usr/lib/gcc/i486-linux-gnu/4.7/include/stdarg.h" 3
...
unsigned int (*hashfunction)(void *arg_0x404de320), 
int (*key_eq_fn)(void *arg_0x404de768, void *arg_0x404de8e0));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x40607010, int arg_0x40607168);
static double RandomUniform(void );
...
#line 44
TMicro;
# 4 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandry.h"
...
typedef nx_struct GPSCoordinate {
  nx_uint16_t x;
  nx_uint16_t y;
} __attribute__((packed)) GPSCoordinate;
...
} __attribute__((packed)) MoteMessage;
...
typedef nx_struct KnownMotes {
  nx_uint16_t nodeID;
  GPSCoordinate gpsCoordinate;
} __attribute__((packed)) KnownMotes;
...
typedef TMilli SensorNetworkForAnimalHusbandryC$Timer0$precision_tag;
typedef KnownMotes SensorNetworkForAnimalHusbandryC$Queue$t;
typedef TMilli SensorNetworkForAnimalHusbandryC$TimeStamp0$precision_tag;
typedef uint32_t SensorNetworkForAnimalHusbandryC$TimeStamp0$size_type;
...
static void SensorNetworkForAnimalHusbandryC$Timer0$fired(void );
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void SensorNetworkForAnimalHusbandryC$AMControl$startDone(error_t error);
#line 138
static void SensorNetworkForAnimalHusbandryC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void SensorNetworkForAnimalHusbandryC$Boot$booted(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void SensorNetworkForAnimalHusbandryC$AMSend$sendDone(
#line 103
message_t * msg, 
...
SensorNetworkForAnimalHusbandryC$Receive$receive(
#line 71
message_t * msg, 
void * payload, 
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void SensorNetworkForAnimalHusbandryC$Timer0$startPeriodic(uint32_t dt);
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SensorNetworkForAnimalHusbandryC$AMControl$start(void );
...
SensorNetworkForAnimalHusbandryC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t SensorNetworkForAnimalHusbandryC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 18 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
uint16_t SensorNetworkForAnimalHusbandryC$counter[1000];
bool SensorNetworkForAnimalHusbandryC$firstMessage[1000];
bool SensorNetworkForAnimalHusbandryC$busy[1000];
message_t SensorNetworkForAnimalHusbandryC$pkt[1000];

static void SensorNetworkForAnimalHusbandryC$SendBroadcastMessage(void );
#line 35
static inline void SensorNetworkForAnimalHusbandryC$Boot$booted(void );




static inline void SensorNetworkForAnimalHusbandryC$AMControl$startDone(error_t err);
#line 54
static inline void SensorNetworkForAnimalHusbandryC$AMControl$stopDone(error_t err);


static inline void SensorNetworkForAnimalHusbandryC$AMSend$sendDone(message_t *msg, error_t error);





static inline void SensorNetworkForAnimalHusbandryC$Timer0$fired(void );





static inline message_t *SensorNetworkForAnimalHusbandryC$Receive$receive(message_t *msg, void *payload, uint8_t len);
# 53 "/opt/tinyos-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 69 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline message_t *SensorNetworkForAnimalHusbandryC$Receive$receive(message_t *msg, void *payload, uint8_t len)
#line 69
{

  if (len == sizeof(MoteMessage )) {
      MoteMessage *mmpkt = (MoteMessage *)payload;

      sim_log_debug(153U, "SensorNetworkForAnimalHusbandryC", "Received packet of length %hhu, from %hhu with timeStamp %hhu.\n", len, __nesc_ntoh_uint16(mmpkt->nodeID.nxdata), __nesc_ntoh_uint16(mmpkt->timeStamp.nxdata));
    }

  if (!SensorNetworkForAnimalHusbandryC$busy[sim_node()]) {
    if (SensorNetworkForAnimalHusbandryC$firstMessage[sim_node()]) {
      SensorNetworkForAnimalHusbandryC$SendBroadcastMessage();
      }
    }
#line 80
  return msg;
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x4085bac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x4085bac8) {
#line 78
    case 6:
#line 78
      __nesc_result = SensorNetworkForAnimalHusbandryC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x4085bac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * SensorNetworkForAnimalHusbandryC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40b300a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40b300a0, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(181U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(182U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(183U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(184U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}

# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t SensorNetworkForAnimalHusbandryC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x4085b108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x4085b108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x40875178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x40875178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SensorNetworkForAnimalHusbandryC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void SensorNetworkForAnimalHusbandryC$Timer0$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(0U, dt);
#line 64
}
#line 64
# 40 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$AMControl$startDone(error_t err)
#line 40
{
  if (err == SUCCESS) {
      SensorNetworkForAnimalHusbandryC$Timer0$startPeriodic(TIMER_PERIOD_MILLI);
    }
  else {
      SensorNetworkForAnimalHusbandryC$AMControl$start();
    }

  sim_log_debug(151U, "SensorNetworkForAnimalHusbandryC", "SensorNetworkForAnimalHusbandryC: TOS_NODE_ID is %hu.\n", TOS_NODE_ID);
  if (TOS_NODE_ID == 1 && SensorNetworkForAnimalHusbandryC$firstMessage[sim_node()] && !SensorNetworkForAnimalHusbandryC$busy[sim_node()]) {
      SensorNetworkForAnimalHusbandryC$SendBroadcastMessage();
    }
}
...
#line 113
  SensorNetworkForAnimalHusbandryC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
# 54 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$AMControl$stopDone(error_t err)
#line 54
{
}
...
#line 138
  SensorNetworkForAnimalHusbandryC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 57 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$AMSend$sendDone(message_t *msg, error_t error)
#line 57
{
  if (&SensorNetworkForAnimalHusbandryC$pkt[sim_node()] == msg) {
      SensorNetworkForAnimalHusbandryC$busy[sim_node()] = FALSE;
    }
}

# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SensorNetworkForAnimalHusbandryC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40b326a8, message_t * msg, error_t error){
#line 100
  switch (arg_0x40b326a8) {
#line 100
    case 0U:
#line 100
      /*SensorNetworkForAnimalHusbandryAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40b326a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x40393ce0){
#line 75
  switch (arg_0x40393ce0) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x40393ce0);
#line 75
      break;
#line 75
    }
...
#line 53
# 63 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$Timer0$fired(void )
#line 63
{
  SensorNetworkForAnimalHusbandryC$counter[sim_node()]++;
  sim_log_debug(152U, "SensorNetworkForAnimalHusbandryC", "SensorNetworkForAnimalHusbandryC: timer fired, counter is %hu.\n", SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40aee3a8){
#line 83
  switch (arg_0x40aee3a8) {
#line 83
    case 0U:
#line 83
      SensorNetworkForAnimalHusbandryC$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40aee3a8);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(180U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(179U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(176U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(177U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(169U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(159U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(165U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(166U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(171U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 62
# 35 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$Boot$booted(void )
#line 35
{
  sim_log_debug(150U, "SensorNetworkForAnimalHusbandryC", "SensorNetworkForAnimalHusbandryC: boot fired, counter is %hu.\n", SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
  SensorNetworkForAnimalHusbandryC$AMControl$start();
}
...
#line 60
  SensorNetworkForAnimalHusbandryC$Boot$booted();
#line 60
}
#line 60
...
# 23 "/home/crunchbang/workspace/SensorNetworkForAnimalHusbandry/src/SensorNetworkForAnimalHusbandryC.nc"
static void SensorNetworkForAnimalHusbandryC$SendBroadcastMessage(void )
#line 23
{
  MoteMessage *mmpkt = (MoteMessage *)SensorNetworkForAnimalHusbandryC$Packet$getPayload(&SensorNetworkForAnimalHusbandryC$pkt[sim_node()], sizeof(MoteMessage ));

#line 25
  __nesc_hton_uint16(mmpkt->nodeID.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(mmpkt->timeStamp.nxdata, SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
  if (SensorNetworkForAnimalHusbandryC$AMSend$send(AM_BROADCAST_ADDR, &SensorNetworkForAnimalHusbandryC$pkt[sim_node()], sizeof(MoteMessage )) == SUCCESS) {
      sim_log_debug(148U, "SensorNetworkForAnimalHusbandryC", "TOS_NODE_ID: %hhu | TimeStamp: %hhu.\n", TOS_NODE_ID, __nesc_ntoh_uint16(mmpkt->timeStamp.nxdata));
      sim_log_debug(149U, "SensorNetworkForAnimalHusbandryC", "SensorNetworkForAnimalHusbandryC: packet sent.\n");
      SensorNetworkForAnimalHusbandryC$busy[sim_node()] = TRUE;
      SensorNetworkForAnimalHusbandryC$firstMessage[sim_node()] = FALSE;
    }
}
...
#line 285
  ...
  sim_log_debug(168U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(174U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(154U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(155U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(156U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(157U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(175U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(178U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(167U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SensorNetworkForAnimalHusbandryC$counter"))
  {
    *addr = (uintptr_t)&SensorNetworkForAnimalHusbandryC$counter[__nesc_mote];
    *size = sizeof(SensorNetworkForAnimalHusbandryC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SensorNetworkForAnimalHusbandryC$firstMessage"))
  {
    *addr = (uintptr_t)&SensorNetworkForAnimalHusbandryC$firstMessage[__nesc_mote];
    *size = sizeof(SensorNetworkForAnimalHusbandryC$firstMessage[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SensorNetworkForAnimalHusbandryC$busy"))
  {
    *addr = (uintptr_t)&SensorNetworkForAnimalHusbandryC$busy[__nesc_mote];
    *size = sizeof(SensorNetworkForAnimalHusbandryC$busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SensorNetworkForAnimalHusbandryC$pkt"))
  {
    *addr = (uintptr_t)&SensorNetworkForAnimalHusbandryC$pkt[__nesc_mote];
    *size = sizeof(SensorNetworkForAnimalHusbandryC$pkt[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module SensorNetworkForAnimalHusbandryC */
  SensorNetworkForAnimalHusbandryC$counter[__nesc_mote] = 0;
  SensorNetworkForAnimalHusbandryC$firstMessage[__nesc_mote] = TRUE;
  SensorNetworkForAnimalHusbandryC$busy[__nesc_mote] = FALSE;
  memset((void *)&SensorNetworkForAnimalHusbandryC$pkt[__nesc_mote], 0, sizeof SensorNetworkForAnimalHusbandryC$pkt[__nesc_mote]);
