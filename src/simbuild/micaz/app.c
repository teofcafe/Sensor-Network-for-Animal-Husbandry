...
#line 44
TMicro;
# 4 "SensorNetworkForAnimalHusbandry.h"
...
# 17 "SensorNetworkForAnimalHusbandryC.nc"
...
#line 134
# 61 "SensorNetworkForAnimalHusbandryC.nc"
static inline message_t *SensorNetworkForAnimalHusbandryC$Receive$receive(message_t *msg, void *payload, uint8_t len)
#line 61
{
...
#line 65
      ...
      sim_log_debug(162U, "SensorNetworkForAnimalHusbandryC", "Received packet of length %hhu and from %hhu.\n", len, __nesc_ntoh_uint16(btrpkt->nodeid.nxdata));
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x4085fac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x4085fac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x4085fac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x4085d178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x4085d178, msg, payload, len);
#line 78
...
#line 64
# 26 "SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$AMControl$startDone(error_t err)
#line 26
{
  if (err == SUCCESS) {
...
# 35 "SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$AMControl$stopDone(error_t err)
#line 35
{
}
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x4085f108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x4085f108, msg, error);
#line 110
}
#line 110
...
# 38 "SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$AMSend$sendDone(message_t *msg, error_t error)
#line 38
{
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40b6b6a8, message_t * msg, error_t error){
#line 100
  switch (arg_0x40b6b6a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40b6b6a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40b6a0a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40b6a0a0, addr, msg, len);
#line 80
...
#line 126
# 44 "SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$Timer0$fired(void )
#line 44
{
  SensorNetworkForAnimalHusbandryC$counter[sim_node()]++;
  sim_log_debug(159U, "SensorNetworkForAnimalHusbandryC", "SensorNetworkForAnimalHusbandryC: timer fired, counter is %hu.\n", SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
...
#line 51
      ...
      sim_log_debug(160U, "SensorNetworkForAnimalHusbandryC", "TOS_NODE_ID: %hhu.\n", TOS_NODE_ID);
      __nesc_hton_uint16(btrpkt->counter.nxdata, SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
      if (SensorNetworkForAnimalHusbandryC$AMSend$send(AM_BROADCAST_ADDR, &SensorNetworkForAnimalHusbandryC$pkt[sim_node()], sizeof(BlinkToRadioMsg )) == SUCCESS) {
          sim_log_debug(161U, "SensorNetworkForAnimalHusbandryC", "SensorNetworkForAnimalHusbandryC: packet sent.\n", SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40afe3a8){
#line 83
  switch (arg_0x40afe3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40afe3a8);
#line 83
      break;
#line 83
    }
...
#line 62
# 21 "SensorNetworkForAnimalHusbandryC.nc"
static inline void SensorNetworkForAnimalHusbandryC$Boot$booted(void )
#line 21
{
  sim_log_debug(158U, "SensorNetworkForAnimalHusbandryC", "SensorNetworkForAnimalHusbandryC: timer fired, counter is %hu.\n", SensorNetworkForAnimalHusbandryC$counter[sim_node()]);
  SensorNetworkForAnimalHusbandryC$AMControl$start();
}
